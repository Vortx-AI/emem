...
- 115 MCP tools (16 core, 92 extended), 20 static resources + 9 URI
  templates, 173 REST paths under `/v1/*`.
...
> returns an ed25519 receipt that verifies offline. 115 MCP tools, 129
