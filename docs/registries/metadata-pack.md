...
- 110 MCP tools (16 core, 92 extended), 20 static resources + 9 URI
  templates, 166 REST paths under `/v1/*`.
...
> returns an ed25519 receipt that verifies offline. 110 MCP tools, 129
