...
| §17: "MCP tools are a strict read-only subset of REST; writes go through REST only" | **8 of 92 MCP tools write** (§11.1), including the five memory verbs, `emem_entity`, `emem_entity_link`, and `emem_derive`. |
