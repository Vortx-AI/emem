...
(**69 tools** — 10 core / 59 extended). An optional Python sidecar over a Unix domain socket
...
| emem-mcp | MCP tool registry (69 tools) |
...
backed by `crates/emem-mcp/src/lib.rs` (69 tools). Three
