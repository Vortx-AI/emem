...
(**85 tools** — 10 core / 75 extended). An optional Python sidecar over a Unix domain socket
...
| emem-mcp | MCP tool registry (85 tools) |
...
backed by `crates/emem-mcp/src/lib.rs` (85 tools). Three
