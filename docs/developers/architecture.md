...
(**70 tools** — 10 core / 60 extended). An optional Python sidecar over a Unix domain socket
...
| emem-mcp | MCP tool registry (70 tools) |
...
backed by `crates/emem-mcp/src/lib.rs` (70 tools). Three
