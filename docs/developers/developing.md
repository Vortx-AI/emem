...
| `emem-api-rest` | HTTP/MCP router, 173 `.route()` registrations (mapping to 106 OpenAPI-documented REST paths in `openapi.json`, 103 of them under `/v1/*`) + 110 MCP tools (16 core, 92 extended), all inline materializers |
