...
Any host that speaks MCP reaches the same 110 tools at the same URL, whether or
...
registers about 66 KB of descriptors rather than about 288 KB for all 110. The rest
