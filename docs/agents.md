...
port 5051. The live surface documents 167 paths under
`/v1/*` (178 total in `/openapi.json`), 110 MCP tools (18 core, 92 extended, with
...
| Resource | Live count |
|---|---|
| REST paths (OpenAPI) | 178 documented, 167 under `/v1/*` |
