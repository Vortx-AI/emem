...
port 5051. The live surface documents 158 paths under
`/v1/*` (167 total in `/openapi.json`), 108 MCP tools (16 core, 92 extended, with
...
| Resource | Live count |
|---|---|
| REST paths (OpenAPI) | 167 documented, 158 under `/v1/*` |
