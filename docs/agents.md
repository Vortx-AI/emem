...
port 5051. The live surface documents 161 paths under
`/v1/*` (170 total in `/openapi.json`), 108 MCP tools (16 core, 92 extended, with
...
| Resource | Live count |
|---|---|
| REST paths (OpenAPI) | 170 documented, 161 under `/v1/*` |
