...
| `EMEM_WARM_MAX_IO_PRESSURE` | `10` | a due pass waits while more than this percent of the last minute was stalled on IO (`/proc/pressure/io` some avg60); keeps the warmer off a booting store and a busy box |
