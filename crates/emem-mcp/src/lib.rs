...
"band":{"type":"string","description":"One of s2.B02, s2.B03, s2.B04, s2.B08, s2.B11, s2.B12 (Sentinel-2), OR copdem30m.elevation (also elevation / dem) for a static Copernicus GLO-30 DEM field via the dem_raster@1 path (no scene selection; single 1-degree tile)."},
